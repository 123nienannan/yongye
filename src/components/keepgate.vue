<template>
  <div class="keepgate">
    <div class="keepgate_top">
      <i @click="comeback" class="el-icon-back"></i>
      <span>维护闸机</span>
    </div>
    <div class="keepgate_main">
      <p>维护闸机</p>
      <el-form :model="keepgateForm" ref="keepgateForm" label-width="100px" class="demo-ruleForm">
        <el-row>
          <el-col :span="10">
           <el-form-item label="名称:" prop="name">
            <el-input v-model="keepgateForm.name" placeholder="请输入车位编号"></el-input>
           </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :span="10">
           <el-form-item label="车库:" prop="region">
            <el-select v-model="keepgateForm.name" placeholder="开放车位" style="width: 100%;">
